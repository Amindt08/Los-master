...
const TambahGambarCustomer = () => {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
            const imageCustomerResponse = await axios.get(API_ENDPOINTS.GETIMAGECUSTOMER);

            setImageCustomer(imageCustomerResponse.data);
        } catch (error) {
    ...
    const handleAdd = async (image: File) => {
        ...
        try {
            ...
            await axios.post(API_ENDPOINTS.TAMBAHIMAGECUSTOMER, formData, {
                headers: {
    ...
    const handleUpdate = async (Kode: string, image: File) => {
        try {
            ...
            await axios.put(API_ENDPOINTS.UPDATEIMAGECUSTOMER(Kode), formData, {
    ...
    const handleDelete = async (Kode: string) => {
        try {
            await axios.delete(API_ENDPOINTS.DELETEIMAGECUSTOMER(Kode));
...
export default TambahGambarCustomer;