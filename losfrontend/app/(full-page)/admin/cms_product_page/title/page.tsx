...
const TambahTitleProduct = () => {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
            const titleProductResponse = await axios.get(API_ENDPOINTS.GETTITLEPRODUCT);
            setTitleProduct(titleProductResponse.data);
        } catch (error) {
    ...
    const handleAdd = async (Keterangan: string) => {
        try {
            await axios.post(API_ENDPOINTS.TAMBAHTITLEPRODUCT, { Keterangan });
    ...
    const handleUpdate = async (Kode: string, Keterangan: string) => {
        try {
            await axios.put(API_ENDPOINTS.UPDATETITLEPRODUCT(Kode), { Keterangan });
    ...
    const handleDelete = async (Kode: string) => {
        try {
            await axios.delete(API_ENDPOINTS.DELETETITLEPRODUCT(Kode));
...
export default TambahTitleProduct;